...
TIMES="10"
####
KEY2="5973249718:AAEQEcWIjxwTMylzckC1letVvxwSYRRNepU"
...
IZIN=$(curl -sS https://raw.githubusercontent.com/arismaramar/izin/main/ip | grep $MYIP | awk '{print $3}' )
REGIST=$(curl -sS https://raw.githubusercontent.com/arismaramar/izin/main/ip | wc -l )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
TEXT="
...
"'&reply_markup={"inline_keyboard":[[{"text":"🔥ʟɪsᴛ ᴏʀᴅᴇʀ","url":"https://api.whatsapp.com/send?phone=6285365581599&text=Assalamualaikum%20Mass%20Ganteng"},{"text":"⚡ᴀᴅᴍɪɴ","url":"https://t.me/amantubilah"}]]}'
