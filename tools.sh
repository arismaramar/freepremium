...
source /etc/os-release
    if [ -f "/usr/bin/apt-get" ];then
        ...
        echo "contact person t.me/amantubilah"
        sleep 3s
        exit
    fi
}
...
mkdir -p /etc/anggun
mkdir -p /etc/anggun/limit
mkdir -p /etc/anggun/limit/trojan
mkdir -p /etc/anggun/limit/vless
mkdir -p /etc/anggun/limit/vmess
mkdir -p /etc/anggun/limit/shadowsocks
mkdir -p /etc/anggun/limit/ssh
mkdir -p /etc/anggun/limit/ssh/ip
mkdir -p /etc/anggun/limit/trojan/ip
mkdir -p /etc/anggun/limit/trojan/quota
mkdir -p /etc/anggun/limit/vless/ip
mkdir -p /etc/anggun/limit/vless/quota
mkdir -p /etc/anggun/limit/vmess/ip
mkdir -p /etc/anggun/limit/vmess/quota
mkdir -p /etc/anggun/limit/shadowsocks/ip
mkdir -p /etc/anggun/limit/shadowsocks/quota
mkdir -p /etc/anggun/trojan
mkdir -p /etc/anggun/vless
mkdir -p /etc/anggun/vmess
mkdir -p /etc/anggun/shadowsocks
mkdir -p /etc/anggun/log
mkdir -p /etc/anggun/log/trojan
mkdir -p /etc/anggun/log/vless
mkdir -p /etc/anggun/log/vmess
mkdir -p /etc/anggun/log/shadowsocks
...
mkdir -p /etc/anggun/cache/shadowsocks-grpc
...
function fixtema(){
rm -rf //etc/anggun/theme > /dev/null 2>&1
...
<font color="red"><b>********  anggun   ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
}
SystemOperasi
