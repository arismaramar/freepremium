...
mkdir -p /etc/xray
echo -e "[ ${tyblue}NOTES${NC} ] AUTO INSTALL SCRIPT FREEPREMIUM.... "
sleep 1
echo -e "[ ${tyblue}NOTES${NC} ] Multi path, Multi port, support debian 10 , Ubuntu 20-18"
sleep 2
echo -e "[ ${green}INFO${NC} ] By ANGGUN"
sleep 1
echo -e "[ ${green}INFO${NC} ] ANGGUN
sleep 1
secs_to_human() {
...
sleep 2
echo -ne "[ ${green}INFO${NC} ] Check permission : success SSS"
sleep 3
mkdir -p /etc/anggun
...
echo -e  "${tyblue}│    \033[1;37mDARI KAMI                 ${tyblue}│${NC}"
echo -e  "${tyblue}└──────────────────────────────────────────┘${NC}"
echo " "
}
...
#wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/vps.conf"
