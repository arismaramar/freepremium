...
dependencies
clear
wget https://raw.githubusercontent.com/arismaramar/freepremium/main/domaincf.sh
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/nginx.conf" && chmod 777 /etc/nginx/nginx.conf
rm /etc/nginx/conf.d/vps.conf
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/vps.conf" && chmod 777 /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/arismaramar/freepremium/main/index.txt"
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/arismaramar/freepremium/main/udpgw"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/squid3.conf" && chmod 777 /etc/squid/squid.conf
hosnem=( `hostname` )
...
wget https://raw.githubusercontent.com/arismaramar/freepremium/main/vpn.zip
...
#blokirtorrent
wget -qO /usr/bin/clearlog "https://raw.githubusercontent.com/arismaramar/freepremium/main/clearlog.sh" && chmod 777 /usr/bin/clearlog
echo "*/25 * * * * root clearlog" >> /etc/crontab

rm /etc/issue.net > /dev/null 2>&1
echo -e "[ ${green}INFO$NC ] Settings banner"
sleep 1
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/arismaramar/freepremium/main/issue.net" && chmod 777 /etc/issue.net
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/arismaramar/freepremium/main/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
setopserviswebsoket
cd
wget -qO /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/arismaramar/freepremium/main/ssh-wsenabler"
wget -qO /usr/bin/proxy3.js "https://raw.githubusercontent.com/arismaramar/freepremium/main/proxy3.js"
wget -qO /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-dropbear"
wget -qO /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-stunnel"
wget -qO /usr/local/bin/ws-openssh "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-openssh"
wget -qO /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-ovpn"
wget -qO /etc/systemd/system/ws-ovpn.service "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-ovpn.service"
wget -qO /etc/systemd/system/ws-dropbear.service "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-dropbear.service"
wget -qO /etc/systemd/system/ws-stunnel.service "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-stunnel.service"
wget -qO /etc/systemd/system/ws-openssh.service "https://raw.githubusercontent.com/arismaramar/freepremium/main/ws-openssh.service"
sleep 1
...
wget -qO /usr/local/bin/ohp "https://raw.githubusercontent.com/arismaramar/freepremium/main/ohp" && chmod 777 /usr/local/bin/ohp
...
printf "q\n" | rclone config
wget -qO /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/rclone.conf"
...
wget -O /usr/bin/autobackup "https://raw.githubusercontent.com/arismaramar/freepremium/main/autobackup.sh" && chmod +x /usr/bin/autobackup;autobackup > /dev/null 2>&1
cd
#remove file sampah
...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/arismaramar/freepremium/main/menu.sh" && chmod +x /usr/bin/menu
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/arismaramar/freepremium/main/menu-trojan.sh" && chmod +x /usr/bin/menu-trojan
...
wget -q -O /usr/bin/gantidomain "https://raw.githubusercontent.com/arismaramar/freepremium/main/gantidomain.sh" && chmod +x /usr/bin/gantidomain.sh
wget -q -O /usr/bin/apete "https://raw.githubusercontent.com/arismaramar/freepremium/main/apete.sh" && chmod +x /usr/bin/apete;apete > /dev/null 2>&1
wget -q -O /usr/bin/menuslowdns "https://raw.githubusercontent.com/arismaramar/freepremium/main/menuslowdns.sh" && chmod +x /usr/bin/menuslowdns
wget -q -O /usr/bin/menuudp "https://raw.githubusercontent.com/arismaramar/freepremium/main/menuudp.sh" && chmod +x /usr/bin/menuudp
wget -q -O /usr/bin/gantidomain "https://raw.githubusercontent.com/arismaramar/freepremium/main/gantidomain.sh" && chmod +x /usr/bin/gantidomain
wget -q -O /usr/bin/purgenginx "https://raw.githubusercontent.com/arismaramar/freepremium/main/purgenginx.sh" && chmod +x /usr/bin/purgenginx



wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/arismaramar/freepremium/main/auto-set.sh" && chmod +x /usr/bin/auto-set
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/arismaramar/freepremium/main/crt.sh" && chmod +x /usr/bin/crtxray

cd /usr/bin
wget -O speedtest "https://raw.githubusercontent.com/arismaramar/freepremium/main/speedtest_cli.py"
wget -O xp "https://raw.githubusercontent.com/arismaramar/freepremium/main/xp.sh"
...
cd /root/semuamenu
wget https://raw.githubusercontent.com/arismaramar/freepremium/main/menu.zip
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/nginx.conf"
...
uuid=$(cat /proc/sys/kernel/random/uuid)
domainn=$(cat /etc/xray/domain)
wget -O /etc/xray/config.json "https://raw.githubusercontent.com/arismaramar/freepremium/main/config.json.txt"
chmod 777 /etc/xray/config.json
sed -i "s/yaddytampan/${uuid}/g" /etc/xray/config.json

wget -qO /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/arismaramar/freepremium/main/vps.conf"
