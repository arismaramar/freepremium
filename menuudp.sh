...
function installsshudp(){
    wget -qO install-udp "https://raw.githubusercontent.com/arismaramar/freepremium/main/install-udp.sh" && chmod +x install-udp && ./install-udp
    clear
    echo " "
    echo "==========SCRIPT UDP SUKSES TERINSTAL==========="
    echo " "
    ...
    echo "--------Script anggun freepremium------"      | tee -a log-install.txt
    echo ""
    ...
    echo ""
    echo -ne "\033[0;36mpilih aja nomor nya ?\0033[m "
    echo ""
    echo ""
